 ...
 */
 public class SystemProcedures  {
 	...
 	*/
 	 ...
 	 * IN TABLENAME    VARCHAR(128),  IN FILENAME VARCHAR(32672) , 
 	 * IN COLUMNDELIMITER CHAR(1),  IN CHARACTERDELIMITER CHAR(1) ,  
 	 * IN CODESET VARCHAR(128), INÂ  REPLACE SMALLINT)
 	 * @exception  StandardException  Standard exception policy.
      **/
      ...
      * <p>
      * Will be called as 
 	 * SYSCS_IMPORT_DATA (IN SCHEMANAMEÂ  VARCHAR(128), IN TABLENAMEÂ Â Â  VARCHAR(128),Â  
 	 *                    IN INSERTCOLUMNLIST VARCHAR(32762), IN COLUMNINDEXES VARCHAR(32762),
 	 *                    IN FILENAME VARCHAR(32762), IN COLUMNDELIMITER CHAR(1),Â  
 	 *                    IN CHARACTERDELIMITERÂ  CHAR(1) ,Â  IN CODESET VARCHAR(128) , 
      *                    INÂ  REPLACE SMALLINT)
 	 *
 	 * @exception  StandardException  Standard exception policy.
      **/
      ...
      * <p>
      * Will be called as 
 	 * SYSCS_BULK_INSERT (IN SCHEMANAME VARCHAR(128), IN TABLENAMEÂ Â Â  VARCHAR(128),Â  
