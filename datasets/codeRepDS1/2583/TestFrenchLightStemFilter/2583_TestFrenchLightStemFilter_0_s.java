 ...
 public class TestFrenchLightStemFilter extends BaseTokenStreamTestCase {
   ...
   public void testExamples() throws IOException {
     ...
     checkOneTerm(analyzer, "bijouti̬re", "bijouti");
     checkOneTerm(analyzer, "bijoutier", "bijouti");
     
     checkOneTerm(analyzer, "caissi̬re", "caisi");
     ...
     checkOneTerm(analyzer, "compl̬te", "complet");
     ...
     checkOneTerm(analyzer, "cr̩̩es", "cre");
