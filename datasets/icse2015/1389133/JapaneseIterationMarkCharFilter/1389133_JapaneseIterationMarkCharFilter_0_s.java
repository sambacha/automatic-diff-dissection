 ...
 public class JapaneseIterationMarkCharFilter extends CharFilter {
   ...
   private static final char KANJI_ITERATION_MARK = '\u3005';           // ã
 
   private static final char HIRAGANA_ITERATION_MARK = '\u309d';        // ã
 
   private static final char HIRAGANA_VOICED_ITERATION_MARK = '\u309e'; // ã
 
   private static final char KATAKANA_ITERATION_MARK = '\u30fd';        // ã½
 
   private static final char KATAKANA_VOICED_ITERATION_MARK = '\u30fe'; // ã¾
 
   private static final char FULL_STOP_PUNCTUATION = '\u3002';           // ã
 
   // Hiragana to dakuten map (lookup using code point - 0x30abï¼ãï¼*/
   ...
   static {
     ...
     char codePointDifference = '\u30ab' - '\u304b'; // ã« - ã
