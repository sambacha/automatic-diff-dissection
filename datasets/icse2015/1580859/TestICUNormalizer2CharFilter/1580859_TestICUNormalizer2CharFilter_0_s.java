 ...
 public class TestICUNormalizer2CharFilter extends BaseTokenStreamTestCase {
   ...
   public void testNormalization() throws IOException {
     String input = "Ê°ã°ã5ââã±ãï¼ãããã¡ã¼ã®æ­£è¦åã®ãã¹ãï¼ãããããï½¶ï½·ï½¸ï½¹ï½ºï½»ï¾ï½¼ï¾ï½½ï¾ï½¾ï¾ï½¿ï¾gÌê°/ê°à®¨à®¿à¹à¸à¤·à¤¿chkÊ·à¤à¥à¤·à¤¿";
   ...
   public void testTokenStream() throws IOException {
     ...
     assertTokenStreamContents(tokenStream,
       new String[] {"Â°C", "No", "(æ ª)", "ã°ã©ã ", "ã¶", "ã¾", "ãã´"},
   ...
   public void testTokenStream2() throws IOException {
     // 'ã°', '<<'ã, '5', 'â', 'â', 'ã±', 'ã', 'ï½»', '<<', 'ï½¿', '<<'
     String input = "ã°ã5ââã±ãï½»ï¾ï½¿ï¾";
     ...
     assertTokenStreamContents(tokenStream,
       new String[] {"ã", "ã´", "5", "Â°", "c", "n", "o", "(", "æ ª", ")", "ã°", "ã©", "ã ", "ã¶", "ã¾"},
   ...
   public void testMassiveLigature() throws IOException {
     ...
     assertTokenStreamContents(tokenStream,
       new String[] {"ØµÙÙ", "Ø§ÙÙÙ", "Ø¹ÙÙÙ", "ÙØ³ÙÙ"},
       new int[]{0, 0, 0, 0},
       new int[]{0, 0, 0, 1},
       input.length()
     );
