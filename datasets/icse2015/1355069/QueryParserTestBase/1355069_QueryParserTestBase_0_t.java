 ...
 public abstract class QueryParserTestBase extends LuceneTestCase {
   ...
   public void testCJK() throws Exception {
    ...
    // used google to translate the word "term" to japanese -> ç¨èª
   ...
   public void testSimple() throws Exception {
     assertQueryEquals("term term term", null, "term term term");
     assertQueryEquals("tÃ¼rm term term", new MockAnalyzer(random()), "tÃ¼rm term term");
     assertQueryEquals("Ã¼mlaut", new MockAnalyzer(random()), "Ã¼mlaut");
