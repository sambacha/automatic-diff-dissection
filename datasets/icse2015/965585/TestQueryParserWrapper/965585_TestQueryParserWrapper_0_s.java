 ...
 public class TestQueryParserWrapper extends LocalizedTestCase {
   ...
   public void testSimple() throws Exception {
     ...
     assertQueryEquals("tï¿½rm term term", new MockAnalyzer(MockTokenizer.WHITESPACE, false),
         "tï¿½rm term term");
     assertQueryEquals("ï¿½mlaut", new MockAnalyzer(MockTokenizer.WHITESPACE, false), "ï¿½mlaut");
