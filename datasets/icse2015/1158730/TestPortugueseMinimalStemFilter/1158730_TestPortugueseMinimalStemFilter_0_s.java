...
import static org.apache.lucene.analysis.util.VocabularyAssert.*;
 ...
 public class TestPortugueseMinimalStemFilter extends BaseTokenStreamTestCase {
   ...
   public void testExamples() throws IOException {
     ...
     new String[] { 
       "o", "debate", "polÃ­tico", "pelo", "menos", "o", "que", "vem", "a", 
       "pÃºblico", "parece", "de", "modo", "nada", "surpreendente", "restrito",
       "a", "tema", "menor", "mas", "hÃ¡", "evidentemente", "grande", "questÃ£o",
       "em", "jogo", "na", "eleiÃ§Ã£o", "que", "se", "aproximam"
     });
   }
