 ...
 public class TestMorfologikAnalyzer extends BaseTokenStreamTestCase {
   ...
   public final void testSingleTokens() throws IOException {
     ...
     assertAnalyzesToReuse(a, "liÅcie", new String[] { "liÅcie", "liÅÄ", "list", "lista" });
     assertAnalyzesToReuse(a, "danych", new String[] { "dany", "dana", "dane", "daÄ" });
     assertAnalyzesToReuse(a, "ÄÃ³ÄÅÅÅ¼ÅºÄÅ", new String[] { "ÄÃ³ÄÅÅÅ¼ÅºÄÅ" });
   }
   ...
   public final void testLeftoverStems() throws IOException {
     Analyzer a = getTestAnalyzer();
     TokenStream ts_1 = a.tokenStream("dummy", new StringReader("liÅcie"));
   ...
   public final void testCase() throws IOException {
     ...
     assertAnalyzesToReuse(a, "AGD",      new String[] { "AGD", "artykuÅy gospodarstwa domowego" });
     assertAnalyzesToReuse(a, "agd",      new String[] { "artykuÅy gospodarstwa domowego" });
   ...
   public final void testPOSAttribute() throws IOException {
     TokenStream ts = getTestAnalyzer().tokenStream("dummy", new StringReader("liÅcie"));
