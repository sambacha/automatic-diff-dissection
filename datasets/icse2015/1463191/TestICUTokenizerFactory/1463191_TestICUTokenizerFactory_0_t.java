 ...
 public class TestICUTokenizerFactory extends BaseTokenStreamTestCase {
   public void testMixedText() throws Exception {
     Reader reader = new StringReader("à¸à¸²à¸£à¸à¸µà¹à¹à¸à¹à¸à¹à¸­à¸à¹à¸ªà¸à¸à¸§à¹à¸²à¸à¸²à¸à¸à¸µ  This is a test àºàº§à»àº²àºàº­àº");
    ICUTokenizerFactory factory = new ICUTokenizerFactory(new HashMap<String,String>());
     ...
     assertTokenStreamContents(stream,
         ...
         "This", "is", "a", "test", "àºàº§à»àº²", "àºàº­àº"});
   }
   ...
   public void testKeywordTokenizeCyrillicAndThai() throws Exception {
     Reader reader = new StringReader
         ("Some English.  ÐÐµÐ¼Ð½Ð¾Ð³Ð¾ ÑÑÑÑÐºÐ¸Ð¹.  à¸à¹à¸­à¸à¸§à¸²à¸¡à¸ à¸²à¸©à¸²à¹à¸à¸¢à¹à¸¥à¹à¸ à¹ à¸à¹à¸­à¸¢ à¹  More English.");
     final Map<String,String> args = new HashMap<String,String>();
