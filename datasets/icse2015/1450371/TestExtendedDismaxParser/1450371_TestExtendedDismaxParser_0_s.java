...
public class TestExtendedDismaxParser extends AbstractSolrTestCase {
  ...
  public void setUp() throws Exception {
    ...
    super.setUp();
     ...
     assertU(adoc("id", "55", "standardtok", "å¤§"));
     assertU(adoc("id", "56", "standardtok", "å¤§äº"));
     assertU(adoc("id", "57", "standardtok", "å¤§äºæ¹¾"));
     assertU(adoc("id", "58", "HTMLstandardtok", "å¤§"));
     assertU(adoc("id", "59", "HTMLstandardtok", "å¤§äº"));
     assertU(adoc("id", "60", "HTMLstandardtok", "å¤§äºæ¹¾"));
