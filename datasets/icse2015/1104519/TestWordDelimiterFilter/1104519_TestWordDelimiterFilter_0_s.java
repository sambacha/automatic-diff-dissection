...
import org.apache.lucene.analysis.core.WhitespaceTokenizer;
 ...
 public class TestWordDelimiterFilter extends BaseTokenStreamTestCase {
   ...
   ***/
   ...
   {
     WordDelimiterFilter wdf = new WordDelimiterFilter(new SingleTokenTokenStream(new Token("Ã¼belkeit)", 7, 16)), WordDelimiterIterator.DEFAULT_WORD_DELIM_TABLE, 1, 1, 0, 0, 1, 1, 0, 1, 1, null);
   ...
   {
     WordDelimiterFilter wdf = new WordDelimiterFilter(new SingleTokenTokenStream(new Token("(Ã¼belkeit", 7, 17)), WordDelimiterIterator.DEFAULT_WORD_DELIM_TABLE, 1, 1, 0, 0, 1, 1, 0, 1, 1, null);
   ...
   public void testSplits() throws Exception {
     ...
     doSplit("Ð Ð¾Ð±ÐµÑÑ", "Ð Ð¾Ð±ÐµÑÑ");
     // now cause a split (russian camelCase)
     doSplit("Ð Ð¾Ð±ÐÑÑ", "Ð Ð¾Ð±", "ÐÑÑ");
 
     // a composed titlecase character, don't split
     doSplit("aÇungla", "aÇungla");
     
     // a modifier letter, don't split
     doSplit("Ø³ÙÙÙÙÙÙÙÙÙÙÙÙÙÙÙÙÙÙØ§Ù", "Ø³ÙÙÙÙÙÙÙÙÙÙÙÙÙÙÙÙÙÙØ§Ù");
     
     // enclosing mark, don't split
     doSplit("Ûtest", "Ûtest");
