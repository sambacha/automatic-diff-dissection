 ...
 public class TestSnowball extends BaseTokenStreamTestCase {
   ...
   public void testTurkish() throws Exception {
     ...
     assertAnalyzesTo(a, "aÄacÄ±", new String[] { "aÄaÃ§" });
     assertAnalyzesTo(a, "AÄACI", new String[] { "aÄaÃ§" });
   }
   ...
   public void testTurkishBWComp() throws Exception {
     ...
     // AÄACI in turkish lowercases to aÄacÄ±, but with lowercase filter aÄaci.
     // this fails due to wrong casing, because the stemmer
     // will only remove -Ä±, not -i
     assertAnalyzesTo(a, "aÄacÄ±", new String[] { "aÄaÃ§" });
     assertAnalyzesTo(a, "AÄACI", new String[] { "aÄaci" });
   }
