 ...
 public class TestQPHelper extends LocalizedTestCase {
  ...
  public void testCJKSloppyPhrase() throws Exception {
   ...
   public void testSimple() throws Exception {
     ...
     assertQueryEquals("tï¿½rm term term", new WhitespaceAnalyzer(TEST_VERSION_CURRENT),
         "tï¿½rm term term");
     assertQueryEquals("ï¿½mlaut", new WhitespaceAnalyzer(TEST_VERSION_CURRENT), "ï¿½mlaut");
