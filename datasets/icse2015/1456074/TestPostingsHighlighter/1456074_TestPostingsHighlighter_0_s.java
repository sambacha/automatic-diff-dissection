 ...
 public class TestPostingsHighlighter extends LuceneTestCase {
   ...
   public void testCuriousGeorge() throws Exception {
     String text = "Itâs the formula for success for preschoolersâCurious George and fire trucks! " + 
                   "Curious George and the Firefighters is a story based on H. A. and Margret Reyâs " +
