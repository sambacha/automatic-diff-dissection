...
import org.apache.lucene.queryParser.standard.StandardQueryParser;
 ...
 public class TestQPHelper extends LuceneTestCase {
   ...
   public void testCJKTerm() throws Exception {
     ...
     assertEquals(expected, getQuery("ä¸­ AND ä¸­å½", analyzer));
   ...
   public void testSimple() throws Exception {
     ...
     assertQueryEquals("tï¿½rm term term", new MockAnalyzer(random, MockTokenizer.WHITESPACE, false),
         "tï¿½rm term term");
     assertQueryEquals("ï¿½mlaut", new MockAnalyzer(random, MockTokenizer.WHITESPACE, false), "ï¿½mlaut");
