 ...
 public class TestJapaneseTokenizer extends BaseTokenStreamTestCase {
   ...
   public void testDecomposition5() throws Exception {
    TokenStream ts = analyzer.tokenStream("bogus", "ãããããããããããããããããããããããããããããããããããããããã");
     ts.reset();
   ...
   */
   ...
   public void testOnlyPunctuation() throws IOException {
    TokenStream ts = analyzerNoPunct.tokenStream("foo", "ãããã");
     ts.reset();
