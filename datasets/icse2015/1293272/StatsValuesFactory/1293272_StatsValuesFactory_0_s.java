...
import java.util.HashMap;
 ...
 public class StatsValuesFactory {
    ...
    *
    * @param fieldType Type of the field whose statistics will be created by the resulting StatsValues
 ...
 *
 ...
 abstract class AbstractStatsValues<T> implements StatsValues {
   ...
   public void accumulate(String value) {
     count++;
     T typedValue = toTypedValue(value);
    ...
    * {@inheritDoc}
    */
   public void accumulate(String value, int count) {
     this.count += count;
     T typedValue = toTypedValue(value);
     updateMinMax(typedValue, typedValue);
 ...
 class NumericStatsValues extends AbstractStatsValues<Number> {
   ...
   public NumericStatsValues(FieldType fieldType) {
     super(fieldType);
    ...
    * {@inheritDoc}
    */
   protected Double toTypedValue(String value) {
 ...
 class StringStatsValues extends AbstractStatsValues<String> {
    ...
    * {@inheritDoc}
    */
   protected String toTypedValue(String value) {
     return value;
   }
