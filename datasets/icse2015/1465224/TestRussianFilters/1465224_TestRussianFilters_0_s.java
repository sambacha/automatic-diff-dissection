...
public class TestRussianFilters extends BaseTokenStreamTestCase {
   ...
   public void testTokenizer() throws Exception {
     Reader reader = new StringReader("ÐÐ¼ÐµÑÑÐµ Ñ ÑÐµÐ¼ Ð¾ ÑÐ¸Ð»Ðµ ÑÐ»ÐµÐºÑÑÐ¾Ð¼Ð°Ð³Ð½Ð¸ÑÐ½Ð¾Ð¹ 100");
    RussianLetterTokenizerFactory factory = new RussianLetterTokenizerFactory();
    factory.setLuceneMatchVersion(TEST_VERSION_CURRENT);
    Map<String, String> args = Collections.emptyMap();
    factory.init(args);
    Tokenizer stream = factory.create(reader);
     assertTokenStreamContents(stream, new String[] {"ÐÐ¼ÐµÑÑÐµ", "Ñ", "ÑÐµÐ¼", "Ð¾",
         "ÑÐ¸Ð»Ðµ", "ÑÐ»ÐµÐºÑÑÐ¾Ð¼Ð°Ð³Ð½Ð¸ÑÐ½Ð¾Ð¹", "100"});
   }
 }
