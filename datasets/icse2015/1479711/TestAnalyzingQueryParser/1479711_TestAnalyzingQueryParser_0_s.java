   ...
   public void setUp() throws Exception {
    ...
    wildcardExpected = new String[] { "ubersetzung uber*ung", "motley crue motl?* cru?",
     ...
     prefixInput = new String[] { "Ã¼bersetzung Ã¼bersetz*",
         "MÃ¶tley CrÃ¼e MÃ¶tl* crÃ¼*", "RenÃ©? Zellw*" };
     prefixExpected = new String[] { "ubersetzung ubersetz*", "motley crue motl* cru*",
         "rene? zellw*" };
 
     rangeInput = new String[] { "[aa TO bb]", "{AnaÃ¯s TO ZoÃ©}" };
     rangeExpected = new String[] { "[aa TO bb]", "{anais TO zoe}" };
 
     fuzzyInput = new String[] { "Ãbersetzung Ãbersetzung~0.9",
         "MÃ¶tley CrÃ¼e MÃ¶tley~0.75 CrÃ¼e~0.5",
         "RenÃ©e Zellweger RenÃ©e~0.9 Zellweger~" };
