 ...
 /**
  * SQLNationalLongvarchar satisfies the DataValueDescriptor interfaces (i.e., OrderableDataType). It implements a String
 	...
 	extends SQLLongvarchar
 {
 	...
 	public DataValueDescriptor getClone()
 	{
 		try
 		{
 			 ...
 			 */
 			return new SQLNationalLongvarchar(getString(), getLocaleFinder());
 		}
 	...
 	*/
 	...
 	{
 		return TypeId.NATIONAL_LONGVARCHAR_PRECEDENCE;
 	}
