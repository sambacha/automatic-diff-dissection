 ...
 public class PreAnalyzedFieldTest extends LuceneTestCase {
   ...
   private static final String[] valid = {
     ...
     "1 =This is the stored part with \\= \n \\n \t \\t escapes.=one two three  \u0001ÄÄÄÅÅÃ³ÅÅºÅ¼", // stored plus token stream
   ...
   // "1 =test ÄÄÄÅÅÃ³ÅÅºÅ¼ \u0001=one,i=22,s=123,e=128,p=deadbeef,y=word two,i=1,s=5,e=8,y=word three,i=1,s=20,e=22,y=foobar"
   
   private static final String jsonValid = "{\"v\":\"1\",\"str\":\"test ÄÄÄÅÅÃ³ÅÅºÅ¼\",\"tokens\":[" +
