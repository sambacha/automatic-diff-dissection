 ...
 public class TestBrazilianStemmer extends BaseTokenStreamTestCase {
   ...
   public void testStemExclusionTable() throws Exception {
    ...
    a.setStemExclusionTable("quintessÃªncia");
   ...
   public void testStemExclusionTableBWCompat() throws IOException {
     ...
     BrazilianStemFilter filter = new BrazilianStemFilter(
         new LowerCaseTokenizer(TEST_VERSION_CURRENT, new StringReader("BrasÃ­lia Brasilia")), set);
   ...
   public void testWithKeywordAttributeAndExclusionTable() throws IOException {
     ...
     BrazilianStemFilter filter = new BrazilianStemFilter(
         new KeywordMarkerFilter(new LowerCaseTokenizer(TEST_VERSION_CURRENT, new StringReader(
             "BrasÃ­lia Brasilia")), set), set1);
     assertTokenStreamContents(filter, new String[] { "brasÃ­lia", "brasilia" });
   }
